...
curl -s -o /dev/null -i -H "Accept: application/json; charset=UTF-8" -H "Content-Type: application/json" -X POST -d '{"statements": [{"statement": "CREATE (google:Resource {name: \"www.google.com\", location: \"http://www.google.com\"}),(yahoo:Resource {name: \"www.yahoo.com\", location: \"http://www.yahoo.com\"}),(espn:Resource {name: \"espn.go.com\", location: \"http://espn.go.com\"}),(cnn:Resource {name: \"www.cnn.com\", location: \"http://www.cnn.com\"}),(news:Tag {name: \"news\"}),(sports:Tag {name: \"sports\"}),(search:Tag {name: \"search\"}),(google)-[:TAGGED]->(search),(yahoo)-[:TAGGED]->(search),(yahoo)-[:TAGGED]->(news),(cnn)-[:TAGGED]->(news),(espn)-[:TAGGED]->(sports),(espn)-[:TAGGED]->(news)"}]}' http://localhost:7474/db/data/transaction/commit
